...
# ── PAGE CONFIG ───────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="Merchant Risk Analytics",
    page_icon="🛡️",
    layout="wide",
...
st.markdown("Simulate a new merchant onboarding and see the live risk score:")
...
st.markdown("---")
st.markdown(
    "<small style='color:#475569'>Built for Merchant Risk Analytics · "
